...
echo ""
echo "⚠️  Accept self-signed certificate warning in browser for each HTTPS service"
echo ""
echo "=============================================="
...
echo ""
echo "TCP Ports (must be open):"
echo "   • 6090  - noVNC HTTPS (3D simulation)"
echo "   • 7860  - Pipecat HTTPS (WebRTC signaling)"
echo "   • 8002  - NAT API HTTPS"
echo "   • 8443  - Dashboard HTTPS"
echo ""
