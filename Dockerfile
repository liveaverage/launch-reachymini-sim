...
# - Multi-arch: Supports linux/amd64 and linux/arm64 (NVIDIA Jetson/Spark)
################################################################################
...
# Multi-arch: Detects amd64 or arm64 at build time
# ============================================================================
...
# Ports
# ============================================================================
# TCP: 6080 (noVNC), 7860 (Conversation App), 8000 (Dashboard), 8888 (Jupyter)
# UDP: 49152-49252 (WebRTC media for conversation app)
EXPOSE 6080 8000 7860 8888 49152-49252/udp
